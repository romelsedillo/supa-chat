    ...
    <div className="max-w-sm w-full mx-auto p-6 rounded-md shadow-2xl border border-gray-800">
      ...
      >
        ...
        <Input
          ...
          className="text-white border border-violet-400 rounded outline-none focus-visible:ring-2 focus-visible:ring-violet-400 placeholder:text-gray-500 focus:border-none caret-violet-500"
        />
